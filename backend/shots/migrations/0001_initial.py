...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0002_alter_projectdepartment_department'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prom_stage', models.CharField(blank=True, max_length=50, null=True, verbose_name='推进阶段')),
                ('status', models.CharField(choices=[('in_progress', '制作中'), ('review', '审核中'), ('approved', '已通过'), ('need_revision', '需修改')], default='in_progress', max_length=20, verbose_name='制作状态')),
                ('deadline', models.DateField(blank=True, null=True, verbose_name='截止日期')),
                ('duration_frame', models.IntegerField(blank=True, null=True, verbose_name='时长(帧)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_important', models.BooleanField(default=False, help_text='如果标记为重要，当制作人提交镜头时会收到提醒', verbose_name='是否重要提示')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('shot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='shots.shot', verbose_name='关联镜头')),
